...
const CreateCampaign = ({ campingData = null }) => {
    ...
    return ( <
            ...
            div >
            <
            CampinFeatureContaienr campaign = { campaign }
            ...
            <
            ScreenDetails campaign = { campaign }
            ...
            onClick = { createNewCampaign } > { campaign._id ? 'Update campaign' : 'Create Campaign' } <
            /div> {
            didCompleteCampaign && ( <
                Confirmation visible = { didCompleteCampaign }
